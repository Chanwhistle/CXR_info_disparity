#!/bin/bash
# Fine-tune and evaluate the main experiment with Qwen VL.
...
for checkpoint_dir in "${OUTPUT_PATH}"/checkpoint-*; do
    ...
    echo "=== Testing Qwen checkpoint: ${checkpoint_name} ==="
...
echo "=== Qwen main experiment complete: ${OUTPUT_PATH} ==="
